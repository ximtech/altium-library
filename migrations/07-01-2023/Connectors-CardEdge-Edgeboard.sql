...
CREATE TABLE IF NOT EXISTS "Connectors-CardEdge-Edgeboard" (
  ...
  "Card Thickness" varchar(255) NULL,
  ...
  "Flange Feature" varchar(255) NULL,
  ...
  "Number of Positions/Bay/Row" varchar(126) NULL,
...
CREATE INDEX "1969a68b-83f8-485c-aee9-cdec2d0fee38" ON "Connectors-CardEdge-Edgeboard"("Value");

CREATE INDEX "a6199106-efe8-45e9-962a-b683dc04b346" ON "Connectors-CardEdge-Edgeboard"("Mounting Type");
