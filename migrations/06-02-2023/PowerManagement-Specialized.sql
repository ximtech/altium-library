...
CREATE TABLE IF NOT EXISTS "PowerManagement-Specialized" (
...
CREATE INDEX "a98a02d9-3569-49d1-9793-b17cb51b7f00" ON "PowerManagement-Specialized"("Value");

CREATE INDEX "19419aed-2f33-4885-8e8d-8ce5bd3b14d3" ON "PowerManagement-Specialized"("Mounting Type");

INSERT INTO "PowerManagement-Specialized" (
  "Applications",
  "Comment",
