...
CREATE TABLE IF NOT EXISTS "altium"."Amplifiers-Audio" (
...
CREATE INDEX "73230222-4a56-4dd5-a72a-fa09e22d313d" ON "Amplifiers-Audio"("Mounting Type");

CREATE INDEX "e15eca02-58a7-4782-b829-92057b868b56" ON "Amplifiers-Audio"("Value");

INSERT INTO "altium"."Amplifiers-Audio" (
  "Comment",
