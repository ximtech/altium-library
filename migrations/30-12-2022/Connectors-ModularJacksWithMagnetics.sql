...
CREATE INDEX "5fbfb52e-9566-4d96-a91c-f9ad83bfcd86" ON "Connectors-ModularJacksWithMagnetics"("Value");

CREATE INDEX "0a8e1e7b-65aa-4161-a5bd-0e97eb3454f1" ON "Connectors-ModularJacksWithMagnetics"("Mounting Type");
