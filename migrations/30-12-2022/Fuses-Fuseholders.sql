...
CREATE INDEX "b2a7e6d4-9824-4733-b460-2f4af7d9f4a1" ON "Fuses-Fuseholders"("Value");

CREATE INDEX "b4a6fd0a-2571-4f2a-82b8-c1298e91933e" ON "Fuses-Fuseholders"("Mounting Type");
