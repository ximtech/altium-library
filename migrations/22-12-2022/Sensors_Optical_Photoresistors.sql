...
CREATE TABLE IF NOT EXISTS "Sensors_Optical_Photoresistors" (
  ...
  "Cell Resistance @ Illuminance" varchar(256) NULL,
...
CREATE INDEX "4a35a6db-5729-4b61-83fd-f23f2cce2856" ON "Sensors_Optical_Photoresistors"("Mounting Type");

INSERT INTO "Sensors_Optical_Photoresistors" (
