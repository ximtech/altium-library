...
CREATE TABLE IF NOT EXISTS "Resistors_Slide_Potentiometers" (
...
CREATE INDEX "5ebd6556-208a-445c-b045-5ea13ba3012d" ON "Resistors_Slide_Potentiometers"("Mounting Type");

CREATE INDEX "33b1b730-ccae-4891-aca8-b4cea9a6005e" ON "Resistors_Slide_Potentiometers"("Power (Watts)");

CREATE INDEX "db0a1741-4556-4aed-a421-63941d6ca9b1" ON "Resistors_Slide_Potentiometers"("Resistance");

CREATE INDEX "0843e903-c224-4c79-9f80-d2b71913d6e0" ON "Resistors_Slide_Potentiometers"("Tolerance");

INSERT INTO "Resistors_Slide_Potentiometers" (
  "Adjustment Type",
  "Comment",
