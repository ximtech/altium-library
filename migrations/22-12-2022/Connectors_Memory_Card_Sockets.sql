...
CREATE TABLE IF NOT EXISTS "Connectors_Memory_Card_Sockets" (
...
CREATE INDEX "7eb5bef5-1482-42b7-b5c7-20fb39cfcd2a" ON "Connectors_Memory_Card_Sockets"("Mounting Type");

INSERT INTO "Connectors_Memory_Card_Sockets" (
  "Card Type",
  "Comment",
