...
CREATE TABLE IF NOT EXISTS "Logic_Linear_Comparators" (
  "id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  "CMRR, PSRR (Typ)" varchar(126) NULL,
  ...
  "Hysteresis" varchar(126) NULL,
  "Comment" varchar(126) NULL,
  "Operating Temperature" varchar(126) NULL,
  "Propagation Delay (Max)" varchar(64) NULL,
...
CREATE INDEX "414893bf-283a-4879-a592-780c7401827a" ON "Logic_Linear_Comparators"("Mounting Type");

INSERT INTO "Logic_Linear_Comparators" (
  "Comment",
