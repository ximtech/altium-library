...
CREATE TABLE IF NOT EXISTS "Switches - Snap Action Limit" (
...
CREATE INDEX "e7c0eb13-b09e-4262-b008-24485fc968a1" ON "Switches - Snap Action Limit"("Mounting Type");

INSERT INTO "Switches - Snap Action Limit" (
  "Actuator Type",
  "Circuit",
  "Comment",
