...
CREATE TABLE IF NOT EXISTS "Sensors - Humidity Moisture" (
...
CREATE INDEX "06f71f7a-63b5-49ce-a32a-402692ff046f" ON "Sensors - Humidity Moisture"("Mounting Type");

INSERT INTO "Sensors - Humidity Moisture" (
  "Accuracy",
  "Comment",
